	...
	UPackage* Z_Construct_UPackage__Script_QuestSystem()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_UQuestDialog_OnQuestAccepted__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_UQuestDialog_OnQuestQuited__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_QuestSystem_OnQuestAction__DelegateSignature,
			};
