...
{
#if PLATFORM_ANDROID     
	RegionInterface = new AndroidRegionFlag(); 
#endif

}

void ACharacterHUD::OpenGallery()
{
#if PLATFORM_ANDROID
	if(RegionInterface)     
	{
		RegionInterface->OnImageSelected.BindUObject(this, &ACharacterHUD::OnPhotoSelected);
		RegionInterface->OpenGallery();     
	}
#endif
...
void ACharacterHUD::OnPhotoSelected(TArray<uint8> PhotoBytes)
{
...
UTexture2D* ACharacterHUD::LoadImageFromBytes(const TArray<uint8>& ImageBytes)
{
